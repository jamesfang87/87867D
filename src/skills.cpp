...
void skills() {
    ...
    chassis.moveToPoint(-49, 25, 1200, {.forwards = false, .maxSpeed = 70, .minSpeed = 5}, false);
    toggle_clamp();
    ...
    chassis.moveToPose(27, 47, 72, 2400, {.maxSpeed = 100, .minSpeed = 70});
    pros::delay(1200);
    move_arm_to(22, 800);
    ...
    chassis.moveToPoint(0, 48, 800, {.forwards = false, .maxSpeed = 70}, false);
    move_arm_to(0, 4000);
