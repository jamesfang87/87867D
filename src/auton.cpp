...
void blue_neg() {
    ...
    chassis.moveToPoint(9, 37, 1400, {.maxSpeed = 70}, false);

    chassis.turnToPoint(8.5, 46, 800, {.maxSpeed = 90}, false);
    chassis.moveToPoint(8.5, 46, 1400, {.maxSpeed = 70}, false);
    ...
    chassis.moveToPoint(48, 0,  2000, {.maxSpeed = 40}, false);
}
